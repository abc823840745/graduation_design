            ...
            render: (h, params) => {
              return h("div", [
                h(
                  ...
                  {
                    props: {
                      type: this.missionReport[params.index].status == 2 ? "primary" : 'warning'
                    },
                    style: {
                      marginRight: "10px"
                    },
                    on: {
                      click: () => {
                        if (this.missionReport[params.index].status == 2) {
            ...
            render: (h, params) => {
              return h("div", [
                h(
                  ...
                  {
                    props: {
                      type: this.weekReport[params.index].status == 2 ? "primary" : 'warning'
                    },
                    style: {
                      marginRight: "10px"
                    },
                    on: {
                      click: () => {
                        if (this.weekReport[params.index].status == 2) {
