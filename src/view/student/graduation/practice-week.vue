          ...
          },
          {
            ...
            render: (h, params) => {
              return h("Tag", {
                ...
                this.missionReport[params.index].status == -2 ? '已超时' : this.missionReport[params.index].status == 0 ? '进行中' : this.missionReport[params.index].status == -1 ? '未开始' : this.missionReport[params.index].status == 1 ? '审核中' : this.missionReport[params.index].status == 3 ? '已保存' : this.missionReport[params.index].more_time==1?'超时完成': '已完成')
            }
          },
          {
            title: "成绩",
          ...
          },
          {
            ...
            render: (h, params) => {
              return h("Tag", {
                ...
                this.weekReport[params.index].status == -2 ? '已超时' : this.weekReport[params.index].status == 0 ? '进行中' : this.weekReport[params.index].status == -1 ? '未开始' : this.weekReport[params.index].status == 1 ? '审核中' : this.weekReport[params.index].status == 3 ? '已保存' :this.weekReport[params.index].more_time==1?'超时完成':  '已完成')
            }
          },
          {
            title: "成绩",
